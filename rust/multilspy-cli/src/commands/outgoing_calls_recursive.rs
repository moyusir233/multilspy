...
pub async fn handle(project: Option<&str>, file: &str, line: u32, column: u32, max_depth: Option<usize>) -> Result<(), CliError> {
    ...
    let result = client.outgoing_calls_recursive(file_path, line, column, max_depth).await?;
